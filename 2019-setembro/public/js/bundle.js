    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li0, "class", "svelte-jksizx");
    			add_location(li0, file$4, 156, 6, 3391);
    			attr_dev(li1, "class", "svelte-jksizx");
    			add_location(li1, file$4, 159, 6, 3459);
    			attr_dev(li2, "class", "svelte-jksizx");
    			add_location(li2, file$4, 162, 6, 3530);
    			attr_dev(li3, "class", "svelte-jksizx");
    			add_location(li3, file$4, 165, 6, 3599);
    			attr_dev(ul0, "class", "big-buttons-list svelte-jksizx");
    			add_location(ul0, file$4, 155, 4, 3354);
    			attr_dev(li4, "class", "svelte-jksizx");
    			add_location(li4, file$4, 172, 8, 3754);
    			attr_dev(li5, "class", "svelte-jksizx");
    			add_location(li5, file$4, 175, 8, 3853);
    			attr_dev(li6, "class", "svelte-jksizx");
    			add_location(li6, file$4, 178, 8, 3952);
    			attr_dev(li7, "class", "svelte-jksizx");
    			add_location(li7, file$4, 181, 8, 4049);
    			attr_dev(ul1, "class", "func-butons svelte-jksizx");
    			add_location(ul1, file$4, 171, 6, 3720);
    			attr_dev(li8, "class", "svelte-jksizx");
    			add_location(li8, file$4, 186, 8, 4193);
    			attr_dev(li9, "class", "svelte-jksizx");
    			add_location(li9, file$4, 189, 8, 4288);
    			attr_dev(li10, "class", "svelte-jksizx");
    			add_location(li10, file$4, 192, 8, 4383);
    			attr_dev(li11, "class", "svelte-jksizx");
    			add_location(li11, file$4, 195, 8, 4478);
    			attr_dev(ul2, "class", "oper-buttons svelte-jksizx");
    			add_location(ul2, file$4, 185, 6, 4158);
    			attr_dev(section0, "class", "wrap-functions svelte-jksizx");
    			add_location(section0, file$4, 170, 4, 3680);
    			attr_dev(li12, "class", "svelte-jksizx");
    			add_location(li12, file$4, 202, 8, 4672);
    			attr_dev(li13, "class", "svelte-jksizx");
    			add_location(li13, file$4, 205, 8, 4750);
    			attr_dev(li14, "class", "svelte-jksizx");
    			add_location(li14, file$4, 208, 8, 4825);
    			attr_dev(li15, "class", "svelte-jksizx");
    			add_location(li15, file$4, 211, 8, 4900);
    			attr_dev(li16, "class", "svelte-jksizx");
    			add_location(li16, file$4, 214, 8, 4975);
    			attr_dev(li17, "class", "svelte-jksizx");
    			add_location(li17, file$4, 217, 8, 5050);
    			attr_dev(li18, "class", "svelte-jksizx");
    			add_location(li18, file$4, 220, 8, 5126);
    			attr_dev(li19, "class", "svelte-jksizx");
    			add_location(li19, file$4, 223, 8, 5201);
    			attr_dev(li20, "class", "svelte-jksizx");
    			add_location(li20, file$4, 226, 8, 5276);
    			attr_dev(li21, "class", "svelte-jksizx");
    			add_location(li21, file$4, 229, 8, 5351);
    			attr_dev(ul3, "class", "middle-buttons svelte-jksizx");
    			add_location(ul3, file$4, 201, 6, 4635);
    			attr_dev(section1, "class", "wrap-middle svelte-jksizx");
    			add_location(section1, file$4, 200, 4, 4598);
    			attr_dev(div, "class", "inner-keyboard-container svelte-jksizx");
    			add_location(div, file$4, 154, 2, 3310);
    			attr_dev(section2, "class", "keyboard-container svelte-jksizx");
    			add_location(section2, file$4, 153, 0, 3270);
    		},
