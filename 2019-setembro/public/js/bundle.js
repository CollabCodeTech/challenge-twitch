...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$3, 42, 2, 762);
    			attr_dev(span1, "class", "tone svelte-12fuhl8");
    			add_location(span1, file$3, 43, 2, 802);
    			attr_dev(button, "class", "middle-button svelte-12fuhl8");
    			add_location(button, file$3, 41, 0, 728);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 26, 0, 434);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { YellowButton, text } = $$props;

    	const writable_props = ['YellowButton', 'text'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<YellowButton> was created with unknown prop '${key}'`);
    	});

    	$$self.$set = $$props => {
    		if ('YellowButton' in $$props) $$invalidate('YellowButton', YellowButton = $$props.YellowButton);
    		if ('text' in $$props) $$invalidate('text', text = $$props.text);
    	};

    	$$self.$capture_state = () => {
    		return { YellowButton, text };
    	};
    ...
    class YellowButton_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$4, safe_not_equal, ["YellowButton", "text"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "YellowButton_1", options, id: create_fragment$4.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.YellowButton === undefined && !('YellowButton' in props)) {
    			console.warn("<YellowButton> was created without expected prop 'YellowButton'");
    		}
    		if (ctx.text === undefined && !('text' in props)) {
    ...
    function create_fragment$5(ctx) {
    	...
    	var yellowbutton0 = new YellowButton_1({
    		props: { text: "adição" },
    		$$inline: true
    	});

    	var yellowbutton1 = new YellowButton_1({
    		props: { text: "subtração" },
    		$$inline: true
    	});

    	var yellowbutton2 = new YellowButton_1({
    		props: { text: "multiplicação" },
    		$$inline: true
    	});

    	var yellowbutton3 = new YellowButton_1({
    		props: { text: "divisão" },
    		$$inline: true
    	});

    	var yellowbutton4 = new YellowButton_1({
    		props: { text: "aritmética" },
    		$$inline: true
    	});

    	var yellowbutton5 = new YellowButton_1({
    		props: { text: "operação" },
    		$$inline: true
    	});

    	var yellowbutton6 = new YellowButton_1({
    		props: { text: "siga-me" },
    		$$inline: true
    	});

    	var yellowbutton7 = new YellowButton_1({
    		props: { text: "memória tons" },
    		$$inline: true
    	});

    	var yellowbutton8 = new YellowButton_1({
    		props: { text: "número do meio" },
    		$$inline: true
    	});

    	var yellowbutton9 = new YellowButton_1({
    ...
    class Keyboard_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$5, safe_not_equal, ["Keyboard"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Keyboard_1", options, id: create_fragment$5.name });
