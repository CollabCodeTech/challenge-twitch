/**
 * Pense-Bem Logica desenvolvido por
 * <leandro@tia.mat.br> e <juca@members.fsf.org>
 * 
...
Livro = {
    ...
    getCorrectAnswer: function() {
      ...
      const index = Math.floor((Livro.currentQuestion - 1) / 15);
      const question = (Livro.currentQuestion % 15 > 0 ? Livro.currentQuestion % 15 : 15)

      const answers = patternList[index];

      return answers[(Livro.bookNumber+question)%16]
    },
    buttonPress: function(b) {
        switch (Livro.state) {
        case Livro.StateChoosingBook:
